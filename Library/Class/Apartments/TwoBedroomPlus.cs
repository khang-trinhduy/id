...
{
    public class TwoBedroomPlusApartment : Apartment
    {
        public TwoBedroomPlusApartment(double price, string name, string direction, string view, int floor, double area)
        {
            this.Area = area;
            this.Name = name;
